...
function App() {
    ...
    const openConfigModal = async (id) => {
        ...
        try {
            ...
            setConfigFields({
                ...
                followupAudioEnabled: account.followup_audio_enabled !== undefined && account.followup_audio_enabled !== null ? !!account.followup_audio_enabled : true,
                ...
                followupMediaInterval: account.followup_media_interval || 2,
                ...
                groupAudioEnabled: account.group_audio_enabled !== undefined && account.group_audio_enabled !== null ? !!account.group_audio_enabled : true,
                ...
                groupMediaInterval: account.group_media_interval || 2,
                ...
                globalGroupDelayMinutes: account.global_group_delay_minutes ?? 2,
                globalPrivateDelayMinutes: account.global_private_delay_minutes ?? 2,
    ...
    const saveConfig = async () => {
        ...
        const config = {
            ...
            followup_media_interval: parseInt(configFields.followupMediaInterval) || 2,
            ...
            group_media_interval: parseInt(configFields.groupMediaInterval) || 2,
